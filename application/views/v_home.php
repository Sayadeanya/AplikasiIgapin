...
<body>
	...
	<div id="wrapper" style="background:#3f6bb5">
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="panel panel-primary">
						<div class="panel-heading" style="background: #3f6bb5;">
							<div class="row">
								<div class="col-xs-3">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">
										<?php $rtotalsiswa = $totalsiswa->row_array();
										echo $rtotalsiswa['countsiswa']; ?>
									</div>
									<div>Total Siswa!</div>
								</div>
							</div>
					...
					<div class="panel panel-primary">
						<div class="panel-heading" style="background: #3f6bb5;">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">
										<?php $rtotalkelas = $totalkelas->row_array();
										echo $rtotalkelas['countkelas']; ?>
									</div>
									<div>Total Kelas!</div>
								</div>
							</div>
					...
					<div class="panel panel-primary">
						<div class="panel-heading" style= "background:#3f6bb5">
							<div class="row">
								...
								<div class="col-xs-9 text-right">
									<div class="huge">
										<?php $rtotalpembayaran = $totalpembayaran->row_array();
										echo $rtotalpembayaran['countpembayaran']; ?>
									</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="fa fa-bar-chart-o fa-fw"></i> Data Transaksi
						</div>
						<!-- /.panel-heading -->
	...
	echo "<script type='text/javascript'>
			$(function() {
				Morris.Area({
					...
					data: [";
	$no = 1;
	foreach ($statistik->result_array() as $d) {
		echo "{
				    period: '" . $d['tahun_bulan'] . "',
					pembayar: " . $d['jumlah_pembayar'] . "
			  },";
	}
	echo "],
			  xkey: ['period'],
			  ykeys: ['pembayar'],
			  labels: ['Jumlah Pembayar'],
			  pointSize: 2,
			  hideHover: 'auto',
			  resize: true
				});
