...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background:#80f2f2">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Siswa <small>Tampil</small></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
								...
								?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center tooltip-demo">
												<a href="<?php echo site_url('datasiswa/formedit/'.$d['nisn']);?>">
													<span class='glyphicon glyphicon-edit' data-toggle='tooltip' data-placement='top' title='Ubah'></span>
												</a> | 
												<a href='#' data-href=<?php echo site_url('datasiswa/hapus/'.$d['nisn']);?> data-toggle='modal' data-target='#myModal'>
