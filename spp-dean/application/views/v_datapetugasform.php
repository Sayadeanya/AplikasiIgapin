                                    ...
                                    <form role="form" method="post">
										...
										<div class="form-group">
											...
											<?php }
												...
												<input class="form-control" placeholder="Password" name="password" type="text" value="<?php echo $satu['password'];?>">
												<?php echo form_error('password','<p class="text-danger">','</p>'); ?>
											<?php }
											?>
                                        </div>
										<div class="form-group">
											...
											if ($satu['nama_petugas']==""){ ?>
												<input class="form-control" placeholder="Nama Petugas" name="namapetugas" type="text">
...
v_datapetugasform.php
Menampilkan v_datapetugasform.php.