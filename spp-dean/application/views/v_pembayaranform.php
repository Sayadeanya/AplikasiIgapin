...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="background:#80f2f2">
<?php 
		if ($satu['nisn']==''){
?>
			<div class="row">
								...
								<div class="col-lg-12">
                                    <form role="form" method="post" enctype="multipart/form-data">
										...
										<div class="wraper form-group input-group col-lg-5">
                                            <input type="text" class="form-control" placeholder="Cari nisn..." value="<?php echo $satu['nisn'];?>" disabled>
                                            <span class="input-group-btn">
                                                <button class="btn btn-default" type="button" data-toggle="modal" data-target="#myModal"><i class="fa fa-search"></i> Cari NISN</button>
                                            </span>
                                        </div>
										<!-- Modal -->
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title" id="myModalLabel">Cari NISN</h4>
													</div>
																...
																<tr class="odd gradeX">
																	...
																	<td class="center tooltip-demo">
																		<a href="<?php echo site_url('pembayaran/form/'.$d['nisn']);?>">
																			<button type="button" class="btn btn-primary btn-xs">Pilih Siswa</button>
																		</a>
																	</td>
																</tr>
														<?php
                           ...
                           <?php
							  ...
							  <div class="col-md-12">
										...
										<div class="form-group input-group">
											<button type="submit" name="proses" class="btn btn-outline btn-success" Value="Proses">Proses Pembayaran</button>
											<a href="<?php echo site_url();?>pembayaran/" class="btn btn-outline btn-danger">Reset Data</a>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="center tooltip-demo">
												<a href="<?php echo site_url('pembayaran/kwitansi/'.$d['id_pembayaran']);?>" target="_blank">
													<button type="button" class="btn btn-primary btn-xs">Cetak Kwitansi</button>
												</a>
											</td>
                                        </tr>
								<?php
